							...
							<form class="form-horizontal" action="<%=editUrl%>" id="myform" method="post" enctype="multipart/form-data">
								<fieldset>
									<div class="form-group" id="eidDiv">
										...
										<div class="col-md-5">${editEmp.eid}</div>
										<!-- 定义表单错误提示显示元素 -->
									...
									<div class="form-group" id="nameDiv">
										...
										<div class="col-md-5">
											...
											<input type="text" id="name" name="name" class="form-control"
												placeholder="请输入雇员姓名" value="${editEmp.name }">
										</div>
										<!-- 定义表单错误提示显示元素 -->
									...
									<div class="form-group" id="sexDiv">
										...
										<div class="col-md-5">
											<div class="radio-inline">
												<label><input type="radio" name="sex" id="sex" value="男" ${editEmp.sex == "男" ? "checked" : ""}>男</label>
											</div>
											<div class="radio-inline">
												<label><input type="radio" name="sex" id="sex" value="女" ${editEmp.sex == "女" ? "checked" : ""}>女</label>
											</div>
										</div>
										<!-- 定义表单错误提示显示元素 -->
										...
										<div class="col-md-5">
											<select id="dept.did" name="dept.did" class="form-control">
												<c:forEach items="${allDepts}" var="dept">
													<option value="${dept.did}" ${editEmp.dept.did==dept.did?"selected" : ""}>${dept.title}</option>
												</c:forEach>
											</select>
										</div>
										<!-- 定义表单错误提示显示元素 -->
									...
									<div class="form-group" id="phoneDiv">
										...
										<div class="col-md-5">
											...
											<input type="text" id="phone" name="phone" class="form-control"
												placeholder="请输入联系电话" value="${editEmp.phone}">
										</div>
										<!-- 定义表单错误提示显示元素 -->
										...
										<div class="col-md-5">
											<select id="level.lid" name="level.lid" class="form-control">
												<c:forEach items="${allLevels}" var="lev">
													<option value="${lev.lid}" ${editEmp.level.lid==lev.lid ? "selected" : ""}>${lev.title}（${lev.losal} ~ ${lev.hisal}）</option>
												</c:forEach>
											</select>
										</div>
										<!-- 定义表单错误提示显示元素 -->
									...
									<div class="form-group" id="salaryDiv">
										...
										<div class="col-md-5">
											...
											<input type="text" id="salary" name="salary" class="form-control"
												placeholder="请输入基本工资" value="${editEmp.salary}">
										</div>
										<!-- 定义表单错误提示显示元素 -->
									...
									<div class="form-group">
										<div class="col-md-5 col-md-offset-3">
											<input type="hidden" name="eid" value="${editEmp.eid}">
											<input type="hidden" name="photo" value="${editEmp.photo}">
